package com.example.androidannotationtesttwo.widget.roundimage;
...
public class RoundImageView extends ImageView {
	...
	protected void onDraw(Canvas canvas) {
		...
		if (b == null) {
			Drawable dra = mContext.getResources().getDrawable(
					R.drawable.default_round_head);
			b = drawableToBitamp(dra) ;
		}
