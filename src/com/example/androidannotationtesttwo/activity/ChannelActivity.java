...
import com.example.androidannotationtesttwo.adapter.DragAdapter;
import com.example.androidannotationtesttwo.adapter.OtherAdapter;
...
import com.example.androidannotationtesttwo.widget.DragGrid;
import com.example.androidannotationtesttwo.widget.OtherGridView;
...
//				Toast.makeText(ChannelActivity.this, "ssss", Toast.LENGTH_LONG).show()
					...
					new Handler().postDelayed(new Runnable() {
						...
						public void run() {
							try {
								...
								ChannelManage.getManage(
										App.getApp().getSQLHelper())
				...
				new Handler().postDelayed(new Runnable() {
					...
					public void run() {
						try {
							...
							ChannelManage
									.getManage(App.getApp().getSQLHelper())
