...
import com.example.androidannotationtesttwo.dao.ChannelDao;
import com.example.androidannotationtesttwo.db.SQLHelper;
...
public class ChannelManage {
    ...
    public static ChannelManage getManage(SQLHelper dbHelper) throws SQLException {
        if (channelManage == null)
            synchronized (ChannelManage.class) { //使用synchronized上锁保证唯一访问
                if (channelManage == null) {
